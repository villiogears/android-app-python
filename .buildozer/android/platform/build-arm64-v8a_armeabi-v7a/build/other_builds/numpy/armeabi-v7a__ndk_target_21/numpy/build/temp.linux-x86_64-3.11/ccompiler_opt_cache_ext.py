...
{'cache_infile': True,
 'cache_me': {"('cc_test_flags', ['-O3'])": True,
              ...
              "('feature_flags', 'SSSE3')": ['-msse', '-msse2', '-msse3',
                                             '-mssse3'],
              "('feature_flags', ('FMA3', 'AVX2'))": ['-msse', '-msse2',
                                                      '-msse3', '-mssse3',
                                                      '-msse4.1', '-mpopcnt',
                                                      '-msse4.2', '-mavx',
                                                      '-mf16c', '-mfma',
                                                      '-mavx2'],
              "('feature_flags', {'SSE3', 'SSE2', 'SSE'})": ['-msse', '-msse2',
                                                             '-msse3'],
              ...
              "('feature_test', 'AVX512_KNL', None, 'macros', [])": False,
 ...
 'parse_target_groups': {'SIMD_TEST': (True,
                                       ['AVX512_SKX', 'AVX512F',
                                        ('FMA3', 'AVX2'), 'SSE42'],
                                       [])},
 'sources_status': {'build/src.linux-x86_64-3.11/numpy/core/src/_simd/_simd.dispatch.c': (True,
                                                                                          ['AVX512_SKX',
                                                                                           'AVX512F',
                                                                                           ('FMA3',
                                                                                            'AVX2'),
                                                                                           'SSE42']),
                    'build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_arithm_fp.dispatch.c': (True,
                                                                                                    ['AVX512F',
                                                                                                     'AVX2']),
                    'build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_arithmetic.dispatch.c': (True,
                                                                                                     ['AVX512_SKX',
                                                                                                      'AVX512F',
                                                                                                      'AVX2',
                                                                                                      'SSE41']),
                    'build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_exponent_log.dispatch.c': (True,
                                                                                                       ['AVX512_SKX',
                                                                                                        'AVX512F',
                                                                                                        ('FMA3',
                                                                                                         'AVX2')]),
                    'build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_trigonometric.dispatch.c': (True,
                                                                                                        ['AVX512F',
                                                                                                         ('FMA3',
                                                                                                          'AVX2')]),
                    'build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_umath_fp.dispatch.c': (True,
                                                                                                   ['AVX512_SKX']),
                    'build/src.linux-x86_64-3.11/numpy/core/src/umath/loops_unary_fp.dispatch.c': (True,
                                                                                                   ['SSE41']),
