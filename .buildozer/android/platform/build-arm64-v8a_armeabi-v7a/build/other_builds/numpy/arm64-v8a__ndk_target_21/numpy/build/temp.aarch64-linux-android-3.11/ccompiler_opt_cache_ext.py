...
{'cache_infile': True,
 'cache_me': {"('cc_test_flags', ['-O3'])": True,
              ...
              "('feature_flags', {'NEON', 'NEON_VFPV4', 'ASIMD', 'NEON_FP16'})": [],
 ...
 'feature_min': {'NEON', 'NEON_VFPV4', 'ASIMD', 'NEON_FP16'},
 ...
 'sources_status': {'build/src.aarch64-linux-android-3.11/numpy/core/src/_simd/_simd.dispatch.c': (True,
                                                                                                   []),
                    'build/src.aarch64-linux-android-3.11/numpy/core/src/umath/loops_arithm_fp.dispatch.c': (True,
                                                                                                             []),
                    'build/src.aarch64-linux-android-3.11/numpy/core/src/umath/loops_arithmetic.dispatch.c': (True,
                                                                                                              []),
                    'build/src.aarch64-linux-android-3.11/numpy/core/src/umath/loops_exponent_log.dispatch.c': (True,
                                                                                                                []),
                    'build/src.aarch64-linux-android-3.11/numpy/core/src/umath/loops_trigonometric.dispatch.c': (True,
                                                                                                                 []),
                    'build/src.aarch64-linux-android-3.11/numpy/core/src/umath/loops_umath_fp.dispatch.c': (True,
                                                                                                            []),
                    'build/src.aarch64-linux-android-3.11/numpy/core/src/umath/loops_unary_fp.dispatch.c': (True,
                                                                                                            []),
