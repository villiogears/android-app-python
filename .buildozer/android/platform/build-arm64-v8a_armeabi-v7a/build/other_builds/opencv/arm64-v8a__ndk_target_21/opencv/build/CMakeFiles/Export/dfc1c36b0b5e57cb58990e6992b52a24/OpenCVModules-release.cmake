...
list(APPEND _cmake_import_check_files_for_opencv_flann "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_flann.so" )
...
set_target_properties(opencv_ml PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_ml.so"
  IMPORTED_SONAME_RELEASE "libopencv_ml.so"
  )

list(APPEND _cmake_import_check_targets opencv_ml )
list(APPEND _cmake_import_check_files_for_opencv_ml "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_ml.so" )

# Import target "opencv_photo" for configuration "Release"
set_property(TARGET opencv_photo APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_photo PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_photo.so"
  IMPORTED_SONAME_RELEASE "libopencv_photo.so"
  )

list(APPEND _cmake_import_check_targets opencv_photo )
list(APPEND _cmake_import_check_files_for_opencv_photo "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_photo.so" )

# Import target "opencv_dnn" for configuration "Release"
set_property(TARGET opencv_dnn APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_dnn PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_dnn.so"
  IMPORTED_SONAME_RELEASE "libopencv_dnn.so"
  )

list(APPEND _cmake_import_check_targets opencv_dnn )
list(APPEND _cmake_import_check_files_for_opencv_dnn "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_dnn.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_features2d "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_features2d.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_calib3d "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_calib3d.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_highgui "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_highgui.so" )

# Import target "opencv_objdetect" for configuration "Release"
set_property(TARGET opencv_objdetect APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_objdetect PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_objdetect.so"
  IMPORTED_SONAME_RELEASE "libopencv_objdetect.so"
  )

list(APPEND _cmake_import_check_targets opencv_objdetect )
list(APPEND _cmake_import_check_files_for_opencv_objdetect "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_objdetect.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_stitching "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_stitching.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_video "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_video.so" )
...
set_target_properties(opencv_gapi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_gapi.so"
  IMPORTED_SONAME_RELEASE "libopencv_gapi.so"
  )

list(APPEND _cmake_import_check_targets opencv_gapi )
list(APPEND _cmake_import_check_files_for_opencv_gapi "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_gapi.so" )
