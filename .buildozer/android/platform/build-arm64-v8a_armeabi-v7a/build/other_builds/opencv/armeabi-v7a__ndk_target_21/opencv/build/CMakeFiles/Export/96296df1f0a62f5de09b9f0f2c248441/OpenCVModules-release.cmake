...
list(APPEND _cmake_import_check_files_for_opencv_core "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_core.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_flann "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_flann.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_imgproc "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_imgproc.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_ml "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_ml.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_photo "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_photo.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_dnn "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_dnn.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_features2d "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_features2d.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_imgcodecs "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_imgcodecs.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_videoio "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_videoio.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_calib3d "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_calib3d.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_highgui "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_highgui.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_objdetect "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_objdetect.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_stitching "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_stitching.so" )
...
list(APPEND _cmake_import_check_files_for_opencv_video "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_video.so" )
...
set_target_properties(opencv_gapi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_gapi.so"
  IMPORTED_SONAME_RELEASE "libopencv_gapi.so"
  )

list(APPEND _cmake_import_check_targets opencv_gapi )
list(APPEND _cmake_import_check_files_for_opencv_gapi "${_IMPORT_PREFIX}/sdk/native/libs/armeabi-v7a/libopencv_gapi.so" )
